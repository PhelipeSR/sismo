...
class TabelaDepartamento_model extends CI_Model {
	...
	var $colunas      = array('id','nome');
	var $order_column = array(null,'nome');
		...
		if (isset($_POST['search']['value'])) {
			$this->db
					->group_start()
						...
						->or_like( 'nome', $this->input->post('search',TRUE)['value'] )
					->group_end();
		}
