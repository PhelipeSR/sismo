					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu"> <!-- Menu de conta do usuário -->
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img class="iconUser" src="<?php echo base_url('assets/imagens/iconUser.svg');?>"><span>Chefe de Departamento</span>
							</a>
		...
		<aside class="main-sidebar"> <!-- Coluna da esquerda -->
			...
			<section class="sidebar">
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a id="chefeListarFuncionario"  href="#"><i class="fa fa-user        "></i><span>Funcionários</span></a></li>
					<li><a id="chefeListarMaterias"     href="#"><i class="fa fa-pencil      "></i><span>Matérias</span></a></li>
