					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu"> <!-- Menu de conta do usuário -->
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img class="iconUser" src="<?php echo base_url('assets/imagens/iconUser.svg');?>"><span>Usuário</span>
							</a>
		...
		<aside class="main-sidebar"> <!-- Coluna da esquerda -->
			...
			<section class="sidebar">
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a id="listarMinhasMonitorias" href="#"><i class="fa fa-id-badge   "></i><span> Minhas Monitorias      </span></a></li>
					<li><a id="candidatarMonitoria"    href="#"><i class="fa fa-handshake-o"></i><span> Candidatar a Monitorias</span></a></li>
					<li><a id="listarMonitoriasUser"   href="#"><i class="fa fa-list-ul    "></i><span> Listar Monitores       </span></a></li>
					<li><a id="listarMeusGrupos"       href="#"><i class="fa fa-user-plus  "></i><span> Meus Grupos de Estudo  </span></a></li>
					<li><a id="montarGrupo"            href="#"><i class="fa fa-pencil     "></i><span> Montar Grupo de Estudos</span></a></li>
					<li><a id="usuarioPerfil"          href="#"><i class="fa fa-edit       "></i><span> Perfil                 </span></a></li>
				</ul>
			</section> <!-- /.sidebar -->
		</aside>
