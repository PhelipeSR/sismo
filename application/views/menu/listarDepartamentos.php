<div class="box"> <!-- Default Box -->
	<div class="box-header with-border"> <!-- Header Conteúdo Principal -->
		<center><h3 class="box-title">Departamentos Cadastrados Na Plataforma</h3></center>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Tem certeza que deseja excluir esse departamento?</p>
				</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group has-feedback">
									<input id='inputNome' name="nome" type="text" class="form-control" placeholder="Nome do Departamento">
				...
				<div class="modal-body">
					<form id="formEditar">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group has-feedback">
									<input id='inputNome_e' name="nome" type="text" class="form-control" placeholder="Nome do Departamento">
									<span class="fa fa-paint-brush form-control-feedback"></span>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var table = $('#user_data').DataTable({
				...
				ajax: { url:"<?php echo base_url().'Tabela/departamentos'; ?>",type: "post"},
			...
			$('#formAdicionar').validate({
				...
				messages: {
					nome: {
						required: 'Por favor, digite o nome do departamento',
					},
				},
					...
					$.ajax({
						...
						success: function(retorno){
							if (retorno.erro) {
								...
								$.notify({
									message: "<center>Adição de departamento realizada com sucesso!</center>"
								},{
									type: 'success',
									mouse_over: 'pause',
									placement: {
					...
					$.ajax({
						...
						success: function(retorno){
							if (retorno.erro) {
								...
								table.ajax.reload( null, false );
								$.notify({
									message: "<center>Edição de departamento realizada com sucesso!</center>"
								},{
									type: 'success',
									mouse_over: 'pause',
									placement: {
				...
				$.ajax({
					...
					success: function(retorno){
						if (retorno.erro) {
							...
							table.ajax.reload( null, false );
							$.notify({
								message: "<center>Exclusão de departamento realizada com sucesso!</center>"
							},{
								type: 'success',
								mouse_over: 'pause',
								placement: {
