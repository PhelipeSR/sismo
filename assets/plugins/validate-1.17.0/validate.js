...
// Validação de telofone BR
$.validator.addMethod("matUnB", function(value, element) {
  // allow any non-whitespace characters as the host part
  return this.optional( element ) || /^[0-9]{2}\/[0-9]{7}$/.test( value );
}, 'Forneça uma matrícula válida');
...
$.extend( $.validator.messages, {
	...
	equalTo: "Por favor, forne&ccedil;a o mesmo valor.",
